...
static const char qt_meta_stringdata_Simulation[] = {
    "Simulation\0\0cmb_param_changed(QString)\0"
    "txt_param_changed(QString)\0"
    "simulationStarted()\0simulationFinished()\0"
};
...
int Simulation::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: cmb_param_changed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: txt_param_changed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: simulationStarted(); break;
        case 3: simulationFinished(); break;
        default: ;
        }
        _id -= 4;
    }
